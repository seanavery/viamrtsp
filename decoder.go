...
func newDecoder(codecID C.enum_AVCodecID, avFramePool *framePool, logger logging.Logger) (*decoder, error) {
	...
	// !!! H264 decoder cannot decode to YUYV422
	// codecCtx.pix_fmt = C.AV_PIX_FMT_YUYV422
...
func (d *decoder) decode(nalu []byte) (*C.AVFrame, error) {
	...
	// 		// d.swsCtx = C.sws_getContext(d.src.width, d.src.height, C.AV_PIX_FMT_YUYV422,
